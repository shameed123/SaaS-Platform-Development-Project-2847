...
const { FiMail, FiZap, FiArrowLeft } = FiIcons;
      ...
      <div className="min-h-screen bg-gradient-to-br from-warm-50 via-white to-soft-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="w-16 h-16 bg-soft-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <SafeIcon icon={FiMail} className="w-8 h-8 text-soft-600" />
            </div>
            ...
            <Link
              to="/login"
              className="inline-flex items-center space-x-2 text-warm-600 hover:text-warm-500 transition-colors"
            >
